...
import Browser
import Html exposing (Html, a, br, div, h2, header, img, main_, nav, p, text)
...
view model =
    main_ []
        [ div [ class "topBox" ]
            [ img [ class "hero", src <| VitePluginHelper.asset "/src/assets/images/desktop-image-hero-1.jpg" ] []
            , div [ class "topBoxRight" ]
                [ div [ class "topBoxRightContent" ]
                    [ h2 []
                        [ text "Discover innovative"
                        , br [] []
                        , text "ways to decorate"
                        ]
                    , p []
                        [ text "We provide unmatched quality, comfort, and style for property"
                        , br [] []
                        , text "owners across the country. Our experts combine form and"
                        , br [] []
                        , text "function in bringing your vision to life. Create a room in your"
                        , br [] []
                        , text "own style with our collection and make your property a"
                        , br [] []
                        , text "reflection of you and what you love."
                        ]
                    , a
                        [ class "shopNow", href "/shop" ]
                        [ text "SHOP NOW"
                        , svg
                            [ SvgAttr.width "40"
                            , SvgAttr.height "12"
                            ...
                            [ Svg.path
                                [ SvgAttr.d "M34.05 0l5.481 5.527h.008v.008L40 6l-.461.465v.063l-.062-.001L34.049 12l-.662-.668 4.765-4.805H0v-1h38.206l-4.82-4.86L34.05 0z"
                                , SvgAttr.fill "#000"
                ...
                , div [ class "slideBtnBox" ]
                    [ div [ class "slideBtn" ]
                        [ img [ src <| VitePluginHelper.asset "/src/assets/images/icon-angle-left.svg" ] []
                        ]
                    , div [ class "slideBtn" ]
                        [ img [ src <| VitePluginHelper.asset "/src/assets/images/icon-angle-right.svg" ] []
                        ]
                    ]
                ]
            ]
        , div [ class "bottomBox" ] []
        , header [ class "headerNavLink" ]
            [ a [ href "/home" ]
                [ svg
                    [ SvgAttr.width "62"
                    , SvgAttr.height "14"
            ...
            , nav []
                [ a [ class "navLink", href "/home" ] [ text "home" ]
                , a [ class "navLink", href "/shop" ] [ text "shop" ]
                , a [ class "navLink", href "/about" ] [ text "about" ]
                , a [ class "navLink", href "/contact" ] [ text "contact" ]
                ]
            ]
        ]
